...
public class GLUtils {
    ...
    public static void drawBorder(float size, float x, float y, float x1, float y1) {
        ...
        vertexBuffer.normal(x, y, 0F).endVertex();
        vertexBuffer.normal(x, y1, 0F).endVertex();
        vertexBuffer.normal(x1, y1, 0F).endVertex();
        vertexBuffer.normal(x1, y, 0F).endVertex();
        tessellator.draw();
    ...
    public static void drawRect(float x, float y, float w, float h) {
        ...
        vertexBuffer.normal(x, h, 0F).endVertex();
        vertexBuffer.normal(w, h, 0F).endVertex();
        vertexBuffer.normal(w, y, 0F).endVertex();
        vertexBuffer.normal(x, y, 0F).endVertex();
        tessellator.draw();
        GlStateManager.enableTexture2D();
    }
    ...
    public static void drawGradientRect(int x, int y, int w, int h, int startColor, int endColor) {
        ...
        vertexBuffer.normal( x + w,  y,  0).color(f1, f2, f3, f).endVertex();
        vertexBuffer.normal( x,  y,  0).color(f1, f2, f3, f).endVertex();
        vertexBuffer.normal( x,  y + h,  0).color(f5, f6, f7, f4).endVertex();
        vertexBuffer.normal( x + w,  y + h,  0).color(f5, f6, f7, f4).endVertex();
        tessellator.draw();
