...
public class ToolTipComponent<T> {
    ...
    public static final ToolTipComponent<IChatComponent> EMPTY = text(new ChatComponentText("").setChatStyle(new ChatStyle()));

    public static ToolTipComponent<IChatComponent> empty() {
        return EMPTY;
    }

    public static ToolTipComponent<IChatComponent> text(IChatComponent component) {
    ...
    public static final class ToolTipType<V> {
        ...
        public static final ToolTipType<IChatComponent> TEXT = new ToolTipType<>("TEXT", IChatComponent.class);
