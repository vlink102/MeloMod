...
import me.vlink102.melomod.util.LerpingFloat;
...
//, "DIVINE"
    ...
    public static String another(long millis) {
        ...
        LocalDateTime time = instant.atZone(ZoneId.of("Etc/UTC")).toLocalDateTime();
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy/MM/dd 'at' HH:mm a z", Locale.ENGLISH).withZone(ZoneId.of("Etc/UTC"));
