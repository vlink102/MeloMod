...
public class ScheduledTask {
    ...
    private long addedTicks = MeloMod.INSTANCE.getNewScheduler().getTotalTicks();
    ...
    void setDelay(int delay) {
        this.addedTicks = MeloMod.INSTANCE.getNewScheduler().getTotalTicks();
        this.delay = delay;
    }
